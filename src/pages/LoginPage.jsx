...
const LoginPage = () => {
    ...
    return (
        <div className="d-flex flex-column flex-xl-row justify-content-center align-items-center gap-2 vh-100 vw-100 p-4 overflow-hidden">
            <img src="https://i.postimg.cc/vmPWd0Ht/login-bg.jpg" alt="Imagen de fondo" className='d-none d-xl-block' />
            <img src="https://i.postimg.cc/DZzsBHLK/diseniamos.png" alt="diseñamos" className='img-responsive diseniamos d-xl-none' />
            ...
            <img src="https://i.postimg.cc/MTrB45mf/desarrollamos.png" alt="desarrollamos" className='img-responsive desarrollamos d-xl-none' />
        </div>
    );
};
